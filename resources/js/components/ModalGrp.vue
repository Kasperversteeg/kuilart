					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">    
								...
								<input type="text" class="form-control" name="name" v-model="reservation.name"/>
						...
						<div class="col-md-3">
							<div class="form-group">    
								...
								<input type="text" class="form-control" name="size" v-model="reservation.size"/>
						...
						<div class="col-md-3">
							<div class="form-group">    
								...
								<input type="date" class="form-control" name="date" v-model="reservation.date" @change="getTotal()"/>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">    
								...
								<input type="text" class="form-control" name="mail" placeholder="Optioneel" v-model="reservation.mail"/>
								<span>{{ errors.get('mail') }}</span>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">    
								<label for="phoneNr">Telefoon nummer</label>
								<input type="text" class="form-control" name="phoneNr" placeholder="Optioneel" v-model="reservation.phoneNr"/>
								<span>{{ errors.get('phoneNr') }}</span>
							</div>
						</div>
					</div>
					...
					<div class="row activity-row">
						...
						<div class="col-md-2">
							<div class="form-group">    
								...
								<input type="text" class="form-control" name="startTime" v-model="reservation.startTime"/>
